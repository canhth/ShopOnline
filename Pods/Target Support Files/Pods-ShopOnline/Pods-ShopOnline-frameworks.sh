...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Pods-ShopOnline/ParseFacebookUtils.framework'
  install_framework 'Pods-ShopOnline/PermissionScope.framework'
  install_framework 'Pods-ShopOnline/SACollectionViewVerticalScalingFlowLayout.framework'
  install_framework 'Pods-ShopOnline/SVProgressHUD.framework'
  install_framework 'Pods-ShopOnline/SlideMenuControllerSwift.framework'
  install_framework 'Pods-ShopOnline/Spring.framework'
  install_framework 'Pods-ShopOnline/SwiftPages.framework'
  install_framework 'Pods-ShopOnline/SwiftyJSON.framework'
